...
class ViewController: UIViewController {
    ...
    private func LoadData() {
        ...
        let videoDePath = FileServer.rootPath().appending("/Documents/IMG_0852.MP4")
        ...
        let imageDePath = FileServer.rootPath().appending("/Documents/123.jpg")
        ...
        let gifDePath = FileServer.rootPath().appending("/Documents/collectionViewLayout.gif")
        ...
        let excelDePath = FileServer.rootPath().appending("/Documents/456.xlsx")
        ...
        let pdfDePath = FileServer.rootPath().appending("/Documents/789.pdf")
        ...
        let zipDePath = FileServer.rootPath().appending("/Documents/WKWebView-JS.zip")
        ...
        let audioDePath = FileServer.rootPath().appending("/Documents/345.amr")
        ...
        let htmlDePath = FileServer.rootPath().appending("/Documents/index.html")
        ...
        let txtDePath = FileServer.rootPath().appending("/Documents/shell.rtf")
        ...
        let folerPath = FileServer.rootPath().appending("/Documents/456")
